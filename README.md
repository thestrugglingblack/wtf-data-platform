...
|:-----------------------------------------------------------------------------------------------------------:|:------------------------------------------------------------------------------------------------------------------------------------:|:----------------------------------------------------------------------------:|:---------------------------------------------------------------------------------------------:|:-----------------------------------------------------------------:|
| Create a source pipeline that: - extracts - repair - normalize - validate raw data source from HostedSports | Create data products for consumption: - data dictionary - schema contracts - parquets - data partitioning - manifests and versioning | Create a python package that interfaces with data: - games - teams - players | Create basic stats such as: - Leaderboards - Power Rankings - Ratings - Player/Team Summaries | Create models with data: - EPA - Player Value - Roster - Rankings |
